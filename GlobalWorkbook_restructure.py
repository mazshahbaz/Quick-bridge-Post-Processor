...
class GirderSheet(GlobalWorkbook):
    def __init__(self, workbook, global_girder, label):
        ...
        self.global_table_keys = self.global_girder.global_table_keys #[['M3', 'V2', 'M2', 'V3', 'P', 'T_table']]
...
#            excel_chart = girder_sheet.add_chart({'type': 'scatter',
#                                                  'subtype': 'smooth_with_markers'})
            
#            for combo_column in table.combo_columns:
#                excel_chart.add_series({
#                        'name': [self.girder_label + force_label, ])
...
print(x.girder_sheets[0].global_table_keys)
